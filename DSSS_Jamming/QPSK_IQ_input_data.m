%Toufiqur Rahman Chowdhury for EE 442
%Modified from originally code by written by JC and Bob Gess

%This module generates the data and splits it into the I channel and Q channel

function [data,data2,Isymbols,Qsymbols]=QPSK_IQ_input_data(N,debub_mod)
